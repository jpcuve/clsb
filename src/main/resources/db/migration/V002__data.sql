insert into banks(id, denomination, when_opening, when_closing, when_settlement_completion_target, minimum_pay_in)
values (1, 'TEST-01', '00:15', '23:00', '10:00', '{}');
insert into currencies(id, bank_id, iso, currency_group, when_opening, when_funding_completion_target, when_closing, when_close)
